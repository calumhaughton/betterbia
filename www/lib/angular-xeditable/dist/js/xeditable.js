...
angular.module('xeditable').factory('editableThemes', function() {
  var themes = {
    ...
    'default': {
      ...
      submitTpl:    '<button type="submit" class="button button-clear icon ion-android-done green-icon" ng-click="doneEditing()"></button>',
      cancelTpl:    '<button type="button" ng-click="$form.$cancel(); doneEditing()" class="button button-clear icon ion-android-close red-icon"></button>',
